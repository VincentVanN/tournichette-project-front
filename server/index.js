...
// Certificate
const privateKey = fs.readFileSync('/etc/letsencrypt/live/tournichette.fr/privkey.pem', 'utf8');
const certificate = fs.readFileSync('/etc/letsencrypt/live/tournichette.fr/cert.pem', 'utf8');
const ca = fs.readFileSync('/etc/letsencrypt/live/tournichette.fr/chain.pem', 'utf8');
